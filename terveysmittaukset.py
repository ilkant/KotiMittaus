...
Käyttö:
    ...
    # Lue verensokeri
    python3 terveysmittaukset.py --contour AA:BB:CC:DD:EE:FF

    # Lue verenpaine
    python3 terveysmittaukset.py --omron AA:BB:CC:DD:EE:FF

    # Lue paino + kehonkoostumus
    python3 terveysmittaukset.py --beurer AA:BB:CC:DD:EE:FF

    # Lue kaikki kolme samaan tiedostoon
    python3 terveysmittaukset.py \\
        --contour AA:BB:CC:DD:EE:FF \\
        --omron   BB:CC:DD:EE:FF:GG \\
        --beurer  CC:DD:EE:FF:GG:HH

    # Oma tiedostonimi
    python3 terveysmittaukset.py --beurer AA:BB:CC:DD:EE:FF --excel paino_2026.xlsx
